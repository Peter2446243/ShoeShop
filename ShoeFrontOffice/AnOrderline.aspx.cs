...
public partial class AnOrderline : System.Web.UI.Page
{
    ...
    protected void btnOK_Click(object sender, EventArgs e)
    {
        ...
        AnOrderline.OrderlineNo = txtOrderlineNo.Text;
        //capture the shoe no
        AnOrderline.ShoeNo = txtShoeNo.Text;
        //capture the quantity
        AnOrderline.Quantity = txtQuantity.Text;
    ...
    protected void btnFind_Click(object sender, EventArgs e)
    {
        ...
        if (Found == true)
        {
            ...
            txtOrderlineNo.Text = AnOrderline.OrderlineNo;
            txtShoeNo.Text = AnOrderline.ShoeNo;
            txtQuantity.Text = AnOrderline.Quantity;
        }
        */
    }
}